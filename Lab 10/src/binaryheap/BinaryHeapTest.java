...
public class BinaryHeapTest {
	...
	assertTrue(bh.remove().equals(n1));
	assertTrue(isMinBHeap(bh));
	assertTrue(bh.remove().equals(n2));
	assertTrue(isMinBHeap(bh));
	assertTrue(bh.remove().equals(n3));
	assertTrue(isMinBHeap(bh));
	assertTrue(bh.remove().equals(n4));
	assertTrue(isMinBHeap(bh));
	assertTrue(bh.remove().equals(n5));
	assertTrue(isMinBHeap(bh));
	assertTrue(bh.remove().equals(n6));
	assertTrue(isMinBHeap(bh));
	assertTrue(bh.remove().equals(n7));
	assertTrue(isMinBHeap(bh));
	assertTrue(bh.remove().equals(n8));
	assertTrue(isMinBHeap(bh));
	assertTrue(bh.remove().equals(n9));
	assertTrue(isMinBHeap(bh));
	assertTrue(bh.remove().equals(n10));
	assertTrue(isMinBHeap(bh));
    ...
    /**
     * Returns the left child of a given element in this binary heap, or null if the
     * element has no left child. This method performs a search of the underlying
     * ArrayList object (using the indexOf method) and should be used for testing
     * purposes only. It is not used to implement binary heap adds or removes.
     * 
     ...
     * the element has no right child. This method performs a search of the
     * underlying ArrayList object (using the indexOf method) and should be used for
     * testing purposes only. It is not used to implement binary heap adds or
     * removes.
     * 
     * @param element A binary heap element
    ...
    /**
     * Returns the parent of a given element in this binary heap, or null if the
     * element is the root. This method performs a search of the underlying
     * ArrayList object (using the indexOf method) and should be used for testing
     * purposes only. It is not used to implement binary heap adds or removes.
     * 
     * @param element A binary heap element
    ...
    /**
     * Returns whether a given index is out of range for this binary heap. Since the
     * first element of the underlying ArrayList object is not used, and index is
     * out of range if it is less than 1 or greater than the size of this binary
     * heap.
     * 
    ...
    /**
     * Calculates the depth of a node at a given index in any binary heap. This will
     * be used to test whether an array has the heap property.
     * 
    ...
    /**
     * Determines whether the path from a given leaf in a binary heap is valid. It
     * is valid if the key of the child is always greater than or equal to the key
     * of the parent, and the length of the path from the leaf to the root is equal
     * to the calculated depth of the child's index in a nearly full tree.
     * 
    ...
    /**
     * Determines whether a given binary heap actually is a binary heap. Finds the
     * index of each leaf and checks whether the path from it to the root is valid.
     * 
